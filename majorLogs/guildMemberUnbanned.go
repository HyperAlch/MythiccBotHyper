...
func GuildMemberUnbanned(session *discordgo.Session, guildMemberBanRemovedData *discordgo.GuildBanRemove) {
	defer func() {
		if r := recover(); r != nil {
	...
	user := guildMemberBanRemovedData.User
	...
	_, err = session.ChannelMessageSendEmbed(
		...
		&discordgo.MessageEmbed{
			...
			Image: &discordgo.MessageEmbedImage{
				URL: "https://i.ibb.co/7nqVFKd/unbanned.png",
			},
